  ...
  render() {
    ...
    return (
      <>
        ...
        {this.state.currentResume.photo && (
          <img
            className="photo"
        ...
        >
          ...
          <div style={{ float: "left", marginLeft: "50px" }}>
            {this.state.currentResume.details.slice(0, 3).map((val, index) => (
          ...
          <div style={{ float: "left", marginLeft: "50px" }}>
            {this.state.currentResume.details.slice(3, 6).map((val, index) => (
              <div className="mb-2" key={index}>
                {val.name}: {val.value}
              </div>
            ))}
          ...
          <div style={{ float: "left", marginLeft: "50px" }}>
            {this.state.currentResume.details.slice(6, 9).map((val, index) => (
              <div className="mb-2" key={index}>
                {val.name}: {val.value}
              </div>
            ))}
          ...
          {this.state.currentResume.sections.map((obj, index) => {
            return (
